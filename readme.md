...
1. Clone the repository:
    git clone  https://github.com/Naitik615/TreeVision?tab=readme-ov-file
    cd TreeVision

3. To get a Introduction of preject read README.md or run -
    ./Intro    or     ./intro

4. Ensure treevision.h and treevision.c are in your project folder.

5.    1~  #include "treevision.h"
